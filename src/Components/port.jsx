  ...
  const cards = 7;
    ...
    return (
      <div className="bg-purple-900 min-h-screen font-sans">
        <header className="bg-gradient-to-r sticky top-0 from-purple-900 via-blue-500 to-purple z-10 text-white py-6">
  <div className="container mx-auto px-4 flex flex-wrap md:flex-nowrap justify-between items-center">
    {/* Logo and Name */}
    <div className="flex gap-4 items-center w-full md:w-auto justify-center md:justify-start mb-4 md:mb-0">
      <img
        className="rounded-full ml-0 md:ml-8 h-[55px] w-[55px] object-cover"
        src={image67}
        alt="logo"
      />
      <h1 className="text-2xl md:text-3xl font-bold">Moses M</h1>
    </div>
    ...
    <nav className="w-full md:w-auto">
      <ul className="flex flex-col md:flex-row md:space-x-8 space-y-4 md:space-y-0 items-center">
        <li>
          <a
            href="#about"
            className="hover:underline px-3 hover:bg-blue-500 py-2 italic rounded text-lg md:text-2xl text-center"
          >
            About
          </a>
        </li>
        <li>
          <a
            href="#projects"
            className="hover:underline hover:bg-blue-500 px-3 py-2 italic rounded text-lg md:text-2xl text-center"
          >
            Projects
          </a>
        </li>
        ...
        <Link to="/contact">
          <li>
            <button className="px-4 py-2 border sm:px-2 sm:text-md border-transparent hover:bg-purple-400 hover:text-black hover:border-blue-500 rounded-full bg-purple-700 text-white text-md md:text-lg">
              Hire Me
            </button>
          </li>
        </Link>
